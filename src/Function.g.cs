...
namespace WidgetMarkdown
{
    public class Function
    {
        ...
        private UrlModelStore<WidgetMarkdownInputs> store;

        public async Task<WidgetMarkdownOutputs> Handler(WidgetMarkdownInputs args)
        {
            ...
            if(this.store == null)
            {
                this.store = new UrlModelStore<WidgetMarkdownInputs>();
            }
            

            var l = new InvocationWrapper<WidgetMarkdownInputs,WidgetMarkdownOutputs> (store, WidgetMarkdown.Execute);
